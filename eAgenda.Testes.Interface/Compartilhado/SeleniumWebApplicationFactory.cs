    ...
    public class SeleniumWebApplicationFactory : WebApplicationFactory<Program>
    {
        ...
        public IServiceProvider Servicos
        {
            get
            {
                if (hostKestrel is null)
                    throw new InvalidOperationException("O host Kestrel não foi inicializado");
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                services.AddDbContext<AppDbContext>(options => options.UseInMemoryDatabase("eAgendaTest"));
            });
        }
        ...
        protected override IHost CreateHost(IHostBuilder builder)
        {
            ...
            try
            {
                ...
                if (enderecosDoServidor is null)
                    throw new InvalidOperationException("Não foi possível obter o endereço do servidor Kestrel");
